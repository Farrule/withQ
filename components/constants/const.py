...
EMBED_TEXT = '# withQ\n'
'## 概要\n'
'withQ は、Discord でゲームをする複数の友人に対して一緒にゲームをプレイする機会を提供するボットです。\n'
'## 目的・目標'
'withQ は、ゲームをする複数の友人が簡単に一緒にゲームをプレイできるようにすることを目的としています。\n'
'## 対象ユーザー'
'withQ は、ゲームをする Discord ユーザーを対象としています。\n'
'## 機能\n'
'withQ には、以下の機能があります。\n'
'\n'
'ゲームの募集機能：ゲームをプレイしたいユーザーを募集することができます。\n'
'ゲームのスケジュール調整機能：ゲームをプレイする日時や時間を調整することができます。\n'
'ゲームの参加者管理機能：ゲームに参加するユーザーを管理することができます。\n'
'\n'
'## 使用方法\n'
'\n'
'withQ の使用方法は、以下のとおりです。\n'
'\n'
'withQ を Discord サーバーに追加します。\n'
'withQ が追加されたサーバーにコマンドを送信します。\n'
'\n'
...
'※[締め切り時間]の値が設定されていない場合、24時間後に自動で募集が取り消されます。\n'
'\n'
'\n'
...
'## 更新情報\n'
'\n'
'withQ の更新情報は、GitHub のリリースページで確認してください。\n'
'\n'
'## バグ修正情報\n'
'\n'
'withQ のバグ修正情報は、GitHub の issue ページで確認してください。\n'
'\n'

...
import withQ.commands.help_command as HelpCommand
import withQ.commands.random_command as RandomCommand
import withQ.commands.update_command as UpdateCommand
import withQ.commands.withQ_command as WithQCommand
...
if os.getenv("EXECUTION_ENV") == "DEBUG":
    ...
    import withQ.config.development_const as env_c
...
async def on_ready():
    ...
    import withQ.components.row_view as row_view
    import datetime
    import asyncio
